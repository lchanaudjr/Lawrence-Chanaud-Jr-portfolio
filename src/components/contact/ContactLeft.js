...
const ContactLeft = () => {
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-t from-gradientStart from-75% to-gradientEnd p-4 lgl:p-8 rounded-lg shadow-lg flex flex-col gap-8 justify-center">
      <img
