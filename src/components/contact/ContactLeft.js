...
const ContactLeft = () => {
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-gradientStart to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-lg flex flex-col gap-8 justify-center">
      <img
